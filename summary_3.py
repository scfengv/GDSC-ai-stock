...
output_filename = '/Users/xuzhiwei/GDSC-ai-stock/summary/2020Q4_split_paragraphs_summarize.json'
processed_data = []

with open('/Users/xuzhiwei/GDSC-ai-stock/split_paragraphs/2020Q4_split_paragraphs.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
